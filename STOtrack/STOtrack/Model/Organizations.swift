...
class Organizations {
    ...
    init () {
        ...
        let VNO = OrgDetails(oName: "Vietnamese Organization", oBalance: 700.4)
        discOrgs.append(VNO)
        
        let GLOW = OrgDetails(oName: "Gay Lesbian Or Whatever", oBalance: 776.6)
        discOrgs.append(GLOW)
        
        let SOMOS = OrgDetails(oName: "SOMOS", oBalance: 312.4)
        discOrgs.append(SOMOS)
